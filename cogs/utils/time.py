...
def human_timedelta(dt, *, source=None, short=False):
    ...
    for attr in attrs:
        ...
        if elem > 1:
            output.append(f'{elem} {attr}' if not short else f'{elem}{attr[0]}')
        else:
            output.append(f'{elem} {attr[:-1]}' if not short else f'{elem}{attr[0]}')
