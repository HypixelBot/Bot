...
#Geometrically, an MCR-formatted chunk is a 16x128x16 block column containing a total of 32768 blocksJSON.
...
from cogs.utils.jnbt.mc.world.base import LVLFMT_REGION, _BaseWorld, _BaseDimension, _BaseRegion, _BaseChunk, _BaseBlock
