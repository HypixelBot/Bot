...
#
#An MCA-formatted chunk consists of a sparsely populated column of up to 16 sections (i.e. 1x16x1 sections). Each section contains 16x16x16 blocksJSON.
#Geometrically, an MCA-formatted chunk is a 16x256x16 block column containing a total of 65536 blocksJSON.
...
from cogs.utils.jnbt.mc.world.base import LVLFMT_ANVIL, _BaseWorld, _BaseDimension, _BaseRegion, _BaseChunk, _BaseBlock, _n
